...
| File | Phase | Topic | Output / Verification Gate |
|------|-------|-------|----------------------------|
...
| [`02_phase2_robot_description.md`](file:///home/zsh/mobile_manipulator_ws/prompts/02_phase2_robot_description.md) | Phase 2 | Robot Description (Xacro/URDF) | `check_urdf` passes, RViz display green |
