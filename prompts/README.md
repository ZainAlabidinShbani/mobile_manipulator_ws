...
| [`05_phase5_moveit2_config.md`](file:///home/zsh/mobile_manipulator_ws/prompts/05_phase5_moveit2_config.md) | Phase 5 | MoveIt 2 Configuration | Motion planning + trajectory execution | ☐ next |
| [`06_phase6_nav2.md`](file:///home/zsh/mobile_manipulator_ws/prompts/06_phase6_nav2.md) | Phase 6 | Nav2 Stack | Autonomous navigation to goal pose | ☐ |
...
Completed phase docs (1–4) carry a **Known Gotchas** section and an **As Built** section
